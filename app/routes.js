module.exports = function (app, passport, con, upload) {
    ...
    // show ppt tool
    app.get('/tools/ppt', function (req, res) {
        var sql = "SELECT * FROM `excel`";
    ...
    app.get('/api/copy/:source/:destination', function (req, res) {
    ...
    app.delete('/api/deleteSource', function (req, res) {
    ...
    app.delete('/api/cleanTable', function (req, res) {
        var type = req.body.type;
    ...
    app.post('/api/pyhton', function (req, res) {
